...
USER_TIMEZONE = "Europe/Moscow"  # v023: all user-visible clock times are fixed to MSK (UTC+3)
...
def select_final_signals(
    ...
    *,
    ...
    The structured result is used by v023 statistics tracking so outcomes are

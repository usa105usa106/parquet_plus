...
USER_TIMEZONE = "Europe/Moscow"  # v026: all user-visible clock times are fixed to MSK (UTC+3)
...
def select_final_signals(
    ...
    *,
    ...
    The structured result is used by v026 statistics tracking so outcomes are
